...
awful.screen.connect_for_each_screen(function(s)
  ...
  s.mytasklist = awful.widget.tasklist { screen  = s, filter  = awful.widget.tasklist.filter.focused, widget_template = beautiful.tasklist_widget_template }

  -- Create the wibox
  s.mywibox = awful.wibar({ visible = true, position = "top", screen = s })
