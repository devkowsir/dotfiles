...
static unsigned int dmz = 0; /* make dmenu this wide */
...
usage(void)
{
	fputs("usage: dmenu [-bfivrP] [-l lines] [-p prompt] [-fn font] [-m monitor]\n"
	      "             [-h height] [-x xoffset] [-y yoffset] [-z width]\n"
	      "             [-nb color] [-nf color] [-bw width] [-sb color] [-sf color]\n"
